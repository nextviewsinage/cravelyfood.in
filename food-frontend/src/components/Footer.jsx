        ...
        <div className="footer-top">
          <div className="footer-brand-block">
            ...
            <div className="footer-socials">
              ...
              <a href="https://twitter.com" target="_blank" rel="noreferrer" className="social-icon" aria-label="Twitter">
                <svg width="18" height="18" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.744l7.737-8.835L1.254 2.25H8.08l4.253 5.622zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
              </a>
          ...
          <div className="footer-links-grid">
            <div className="footer-col">
              ...
              <Link className="footer-link" to="/investor-relations">Investor Relations</Link>
            </div>
            <div className="footer-col">
            ...
            <div className="footer-col">
              ...
              <button onClick={() => {}} className="app-badge" style={{ background: 'none', border: 'none', cursor: 'pointer', padding: 0, textAlign: 'left' }}>
