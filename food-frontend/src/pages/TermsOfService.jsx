  ...
  return (
    <div className="static-page">
      ...
      <div className="static-content">
        {[
          { title: '1. Acceptance of Terms', body: 'By accessing or using Cravely Food, you agree to be bound by these Terms of Service. If you do not agree, please do not use our platform.' },
          ...
          { title: '6. Limitation of Liability', body: 'Cravely Food is not liable for delays caused by restaurants, traffic, or weather conditions. Our maximum liability for any claim is limited to the value of the order in question.' },
          ...
          { title: '8. Contact', body: 'For questions about these terms, contact legal@Cravely Food.in' },
        ].map((s) => (
